'''This file was formerly used as a mask import, since the program was initially destined to import and deactivate
different UIs on user interaction. Unfortunately its become too complicated and I gave up on the idea, since the program
is so small anyway, that it doesnt really matter if there are functions the user does not need.'''
