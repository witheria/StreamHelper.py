...
if __name__ == '__main__':
    ...
    #matchTree = get_champions(match_id)
    #for game in matchTree:
    #    print(f"{game} played as {matchTree[game]}")

    print(f"===CHAMPIONS FROM MATCHES OF TEAMID {team_id}===")
    for matchTree in get_matches(team_id):
        print(get_champions(matchTree))
